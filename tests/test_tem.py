...
def test_run_simulator(sample_class):
    """Test whether mrc and log files are generated by simulator. #TODO: have callum run test
...
def test_parse_simulator_data(sample_class, sample_resources):
    ...
    sample_class.generate_simulator_inputs()  # TODO: have callum run test
    sample_class.run_simulator()
    micrograph, particle_stack = sample_class.parse_simulator_data()

    assert particle_stack.shape == (  # TODO: figure out micrograph shape
        1,
        35,
        809,
        809,
