...
class dataset_gen(torch.nn.Module):
    ...
    def run(self):
        """Method to generate a chunk of projection and saving it"""
    ...
    def save_mrc(self, projections, iterations):
        """saves the projection chunks as an mrcs file in the output directory.
        Parameters
        ----------
    ...
    def save_starfile(self):
        """saves the starfile with the metadata of the dataset in the output directory."""
        df = pd.DataFrame(
            data=self.dataframe,
    ...
    def save_configfile(self):
        """saves the config as .txt and .cfg in the output directory."""
    ...
    def init_dir(self):
        """Makes the output directory and puts the path in the config.output_path"""
    ...
    def print_statements(self):
        """Method to print statements about the data"""
