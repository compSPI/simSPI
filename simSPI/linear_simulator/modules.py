...
class simulator(torch.nn.Module):
    ...
    def init_volume(self):
        ...
        Initializaes the mrcfile whose path is given in config.input_volume_path.
...
class Projector(torch.nn.Module):
    ...
    def forward(self, rot_params, proj_axis=-1):
        ...
        ----------
        rot_params: dict of type str to {tensor}
            contains rotation matrix "rotmat" (chunks x 3 x 3) that is
        ...
        projection: tensor
            ...
            (chunks x 1 x sidelen x sidelen)
        """
...
class CTF(torch.nn.Module):
    ...
    def get_ctf(self, ctf_params):
        ...
        ----------
        ctf_params: dict of type str to {tensor}
            contains "defocusU", "defocusV", "defocusAngle",
            all of shape (chunks,1,1,1)
...
class Shift(torch.nn.Module):
    ...
    def forward(self, x_fourier, shift_params={}):
        ...
        -------
            output: torch.Tensor
                batch of modulated fourier images (Bx1xSizexSize)
...
class Noise(torch.nn.Module):
    ...
    def forward(self, proj):
        ...
        -------
        out: torch.Tensor
            noisy projection of shape B,1,sidelen,sidelen
        """
