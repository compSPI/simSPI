...
class TEMSimulator:
    ...
    def parse_simulator_data(self):
        ...
        The micrograph data is parsed from the .mrc files generated by the TEM simulator.
        Individual particles are isolated from micrographs and appended to a list referred
        to as "Particle Stack"
